        ...
        if self.atlas_w != w || self.atlas_h != h {
            self.atlas_texture = crate::ui::widget::gpu_util::create_clamped_texture(
                ...
                crate::ui::widget::gpu_util::ClampedTextureDescriptor {
                    label: "Segmented OnePass Glyph Atlas",
                    width: w,
                    height: h,
...
impl shader::Pipeline for SegmentedOnePassRenderer {
    fn new(device: &icy_ui::wgpu::Device, queue: &icy_ui::wgpu::Queue, format: icy_ui::wgpu::TextureFormat) -> Self {
        ...
        let atlas_texture = crate::ui::widget::gpu_util::create_clamped_texture(
            device,
            crate::ui::widget::gpu_util::ClampedTextureDescriptor {
                label: "Segmented OnePass Atlas (init)",
                width: 1,
                height: 1,
                depth_or_array_layers: 1,
                format: icy_ui::wgpu::TextureFormat::Rgba8UnormSrgb,
        ...
        let pipeline =
            crate::ui::widget::gpu_util::build_alpha_blended_pipeline(device, "Segmented OnePass Pipeline", &pipeline_layout, &shader, format, &vertex_buffers);
