    ...
    fn new(device: &icy_ui::wgpu::Device, queue: &icy_ui::wgpu::Queue, format: icy_ui::wgpu::TextureFormat) -> Self {
        ...
        let bind_group_layout = crate::ui::widget::gpu_util::build_uniform_texture_sampler_layout(
            ...
            crate::ui::widget::gpu_util::UniformTextureSamplerLayout {
                label: "FKey OnePass Bind Group Layout",
        ...
        let pipeline =
            crate::ui::widget::gpu_util::build_alpha_blended_pipeline(device, "FKey OnePass Pipeline", &pipeline_layout, &shader, format, &vertex_buffers);
