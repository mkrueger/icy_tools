...
fn compute_scroll_to_keep_caret_visible(
    caret_col: i32,
    caret_row: i32,
    font_width: f32,
    font_height: f32,
...
// ============================================================================
// Unit tests for scroll_caret_into_view logic
// ============================================================================

#[cfg(test)]
mod scroll_caret_tests {
    ...
    fn caret_at_top_scrolled_down_scrolls_up() {
        ...
        // Row 0 should be visible: new_scroll_y should be 0 (caret_top = 0).
    ...
    fn caret_at_left_edge_scrolls_left() {
        ...
        assert!(result.is_some(), "Expected horizontal scrolling");
        let (new_scroll_x, _) = result.unwrap();
        // caret_left = 0. new_scroll_x should be 0.
    ...
    fn scroll_clamped_to_max() {
        let content_height = 100.0; // small content
        let visible_height = 400.0; // larger viewport

        // When content is smaller than viewport, scrolling should be clamped to 0.
        let result = compute_scroll_to_keep_caret_visible(
            0,
            0,
            FONT_W,
        ...
        if let Some((_, new_scroll_y)) = result {
            // max_scroll_y = (100 - 400).max(0) = 0.
            // So new_scroll_y should be clamped to 0.
