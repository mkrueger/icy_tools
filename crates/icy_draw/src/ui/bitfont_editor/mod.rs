...
use crate::ui::{
    ansi_editor::{PaletteGrid, PaletteGridMessage, SWITCHER_SIZE, constants::SIDEBAR_WIDTH},
    bitfont_editor::tile_view::TileViewCanvas,
};
...
impl BitFontEditor {
    ...
    #[allow(dead_code)]
    pub(crate) fn font_width(&self) -> i32 {
        self.state.font_width()
    }
    ...
    #[allow(dead_code)]
    fn edit_selection(&self) -> Option<icy_engine::Selection> {
        self.state.edit_selection()
    }
