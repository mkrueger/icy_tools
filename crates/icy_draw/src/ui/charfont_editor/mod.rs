...
impl CharFontEditor {
    ...
    fn with_charset_state(charset_state: CharSetEditState, options: Arc<RwLock<Options>>) -> Self {
        let id = unsafe {
    ...
    pub fn with_fonts(fonts: Vec<TdfFont>, file_path: Option<PathBuf>, options: Arc<RwLock<Options>>) -> Self {
