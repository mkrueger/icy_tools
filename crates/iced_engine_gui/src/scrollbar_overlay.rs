    ...
    Message: Clone + 'static,
{
    ...
    fn draw_scrollbar(&self, frame: &mut Frame, size: Size, animated_visibility: f32) {
        ...
        if is_thin {
            ...
            let track_path = Path::rectangle(Point::new(scrollbar_x, 4.0), Size::new(scrollbar_width, size.height - 8.0));
