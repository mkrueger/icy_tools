app-about = Megjelenítő ANSI művészethez, ASCII művészethez és egyéb szöveges műalkotásokhoz

# Parancssori argumentumok
arg-path-help = Megnyitandó fájl vagy könyvtár elérési útja
arg-auto-help = Automatikus görgetés animáció engedélyezése
arg-bps-help = Átviteli sebesség emuláció (pl. 9600, 19200, 38400)
heading-title=Cím
heading-author=Szerző
heading-group=Csoport
heading-screen-mode=Zászlók

menu-item-discuss=Megvitat
menu-item-report-bug=Hiba bejelentése
menu-item-check-releases=Legújabb kiadás
menu-item-auto-scroll=Automatikus görgetés
menu-item-scroll-speed-slow=Lassú sebesség
...
message-loading-image=Kép betöltése…
message-file-not-supported=A fájl { $name } nem támogatott.
button-load-anyways=Betöltés mindenképpen
button-ok=OK
button-cancel=Mégse
button-open=Megnyitás
message-empty=Itt semmit sem látsz, amíg nem választasz egy támogatott fájlt.
...
sauce-dialog-comments-label=Hozzászólások:
...
sauce-field-size=Méret
sauce-field-flags=Jelzők
...
toast-scroll-medium=Görgetési sebesség: közepes
toast-scroll-fast=Görgetési sebesség: gyors

button-play_music=Zene lejátszása
button-stop_music=Zene leállítása
