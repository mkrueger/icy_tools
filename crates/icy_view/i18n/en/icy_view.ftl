...
egui-music-seek = Jump to a position in the song
egui-music-no-audio = No audio output
egui-font-all = All fonts
egui-font-select = Font of the file (mouse wheel to step through)
egui-font-sample = Sample text
egui-font-sample-hint = Rendered in the font; Enter starts a new line. Empty shows the alphabet.
egui-font-spacing = Spacing
egui-font-line-gap = Line gap
egui-font-outline = Outline
egui-font-foreground = Foreground
egui-font-background = Background
egui-font-default-color = Font colors
egui-font-ruler = Width guide
egui-font-reset = Reset
