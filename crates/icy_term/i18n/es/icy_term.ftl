...
settings-modem-list-section = Lista de módems
settings-modem-basic-section = Configuración básica
settings-modem-connection-section = Configuración de conexión
...
settings-modem-char_size = Tamaño carácter
settings-modem-stop_bits = Bits de parada
settings-modem-parity = Paridad
