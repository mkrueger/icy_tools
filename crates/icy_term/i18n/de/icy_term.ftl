...
settings-modem-list-section = Modemliste
settings-modem-basic-section = Grundlegende Einstellungen
settings-modem-connection-section = Verbindungseinstellungen
settings-modem-at-section = AT-Befehle
...
settings-modem-char_size = Zeichenlänge
settings-modem-stop_bits = Stoppbits
settings-modem-parity = Parität
