...
settings-modem-list-section = Lista modemów
settings-modem-basic-section = Ustawienia podstawowe
settings-modem-connection-section = Ustawienia połączenia
settings-modem-at-section = Komendy AT
...
settings-modem-char_size = Rozmiar znaku
settings-modem-stop_bits = Bity stopu
settings-modem-parity = Parzystość
