...
settings-modem-list-section = Modem List
settings-modem-basic-section = Basic Settings
settings-modem-connection-section = Connection Settings
settings-modem-at-section = AT Commands
...
settings-modem-char_size = Char size
settings-modem-stop_bits = Stop bits
settings-modem-parity = Parity
...
dialing_directory-cancel-button = Cancel
