...
settings-modem-list-section = Seznam modemů
settings-modem-basic-section = Základní nastavení
settings-modem-connection-section = Nastavení připojení
settings-modem-at-section = AT příkazy
...
dialing_directory-generate = Generovat
