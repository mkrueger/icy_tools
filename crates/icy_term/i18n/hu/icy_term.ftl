...
settings-monitor-scanlines = Pásztázó vonalak
settings-iemsi-category = IEMSI
settings-iemsi-autologin-section = IEMSI automatikus bejelentkezés
settings-iemsi-alias = Alias
settings-iemsi-location = Helyszín
settings-iemsi-data-phone = Adat telefon
settings-iemsi-voice-phone = Hang telefon
settings-iemsi-birth-date = Születési dátum
...
settings-scaling-nearest = Legközelebbi
...
settings-keybinds-dialing-directory = Tárcsázási könyvtár:
settings-keybinds-send-login = Bejelentkezés küldése:
settings-keybinds-capture-control = Rögzítés vezérlése:
settings-keybinds-show-settings = Beállítások megjelenítése:
settings-keybinds-clear-screen = Képernyő törlése:
settings-keybinds-toggle-fullscreen = Teljes képernyőre váltás:
settings-keybinds-upload = Feltöltés:
settings-keybinds-download = Letöltés:
settings-keybinds-quit = Kilépés:
...
settings-paths-header = Rendszerútvonalak
...
settings-modem-nothing_selected = Nincs modem kiválasztva
settings-modem-list-section = Modemek
settings-modem-device-section = Eszköz
settings-modem-serial-section = Soros Port
settings-modem-commands-section = Modem Parancsok
settings-modem-add-button = Hozzáadás
...
settings-modem-add-tooltip = Új modem hozzáadása
settings-modem-remove-tooltip = Kiválasztott modem eltávolítása
settings-modem-init_command = Init
settings-modem-dial_suffix = Tárcsázási Utótag
settings-modem-hangup_command = Letesz

settings-protocol-category = Protokollok
settings-protocol-list-section = Protokollok
settings-protocol-nothing-selected = Nincs protokoll kiválasztva
settings-protocol-no-selection-hint = Adj hozzá egy protokollt vagy válassz egyet a listából
settings-protocol-add-tooltip = Új protokoll hozzáadása
settings-protocol-remove-tooltip = Kiválasztott protokoll eltávolítása
settings-protocol-move-up-tooltip = Protokoll feljebb mozgatása
settings-protocol-move-down-tooltip = Protokoll lejjebb mozgatása
settings-protocol-general-section = Általános
settings-protocol-commands-section = Parancsok
settings-protocol-id = ID
settings-protocol-name = Név
settings-protocol-description = Leírás
settings-protocol-enabled = Engedélyezve
settings-protocol-batch = Kötegelt átvitel
settings-protocol-auto-transfer = Automatikus átvitel
settings-protocol-send-command = Küldési parancs
settings-protocol-recv-command = Fogadási parancs
settings-protocol-download-signature = Letöltési aláírás
settings-protocol-upload-signature = Feltöltési aláírás
settings-protocol-internal-hint = Belső protokoll - a parancsok opcionálisak
...
dialing_directory-generate = Generálá
...
dialing_directory-comment = Megjegyzés
dialing_directory-delete = Kiválasztott BBS törlése
dialing_directory-add = Új BBS hozzáadása
...
dialing_directory-date-format=%m/%d/%Y %H:%M-kor
dialing_directory-clear-filter = Szűrő törlése
dialing_directory-starred-items = Csillagozott elemek szűrése
...
terminal-hangup = Letesz
terminal-autologin = Felhasználónév/jelszó küldése
terminal-dialing_directory = Tárcsázási könyvtár
terminal-menu = Menü
terminal-menu-copy = Másolás
terminal-menu-paste = Beillesztés
terminal-menu-export = Puffer exportálása…
terminal-menu-info = Terminálinformációk
toast-copied-to-clipboard = Vágólapra másolva
terminal-find-hint = Szöveg keresése
terminal-find-no-results = Nincs találat
terminal-find-results = { $cur } / { $total }
...
protocol-xmodem1k-description = Ritkán használt
protocol-xmodem1kG-description = Ez tényleg létezik?
protocol-ymodem-description = Oké, de a Zmodem jobb
protocol-ymodemg-description = Egy gyors Ymodem változat
protocol-text-description = Szövegfájl feltöltése
...
menu-item-check-releases=Új kiadások
menu-item-settings={ settings-heading }
menu-item-capture-dialog=Rögzítés…
menu-upgrade_version=Frissítés { $version }-ra

toolbar-stop-capture=Rögzítés leállítása
toolbar-show-iemsi=IEMSI megjelenítése
toolbar-hide-iemsi=IEMSI elrejtése
toolbar-stop-playing1 = Kérlek állj le
toolbar-stop-playing2 = A füleim véreznek
toolbar-stop-playing3 = Állítsd le ezt az őrületet
toolbar-stop-playing4 = Könyörgöm
...
help-desc-fullscreen = Teljes képernyős mód váltása
help-desc-clear-screen = Terminál kijelző törlése
help-desc-scrollback = Terminál előzménypuffer megtekintése
...
help-action-scrollback = Előzmények megjelenítése
...
terminal-info-dialog-screen-section = Képernyő
terminal-info-dialog-resolution = Méret
terminal-info-dialog-font-size = Betűméret
terminal-info-dialog-caret-section = Kurzor
terminal-info-dialog-caret-shape = Alak
terminal-info-dialog-caret-position = Pozíció
terminal-info-dialog-caret-visible = Látható
terminal-info-dialog-caret-blinking = Villog
terminal-info-dialog-input-mode = Beviteli Mód
terminal-info-dialog-terminal-section = Terminál
terminal-info-dialog-auto-wrap = Automatikus Törés
terminal-info-dialog-scroll-mode = Görgetési Mód
terminal-info-dialog-margins = Margók
terminal-info-dialog-mouse-tracking = Egér Követés
terminal-info-dialog-inverse-colors = Inverz Színek
terminal-info-dialog-use-ice-colors = Ice Colors
terminal-info-dialog-yes = Igen
terminal-info-dialog-no = Nem
terminal-info-dialog-not-set = Nincs beállítva
terminal-info-dialog-copy-button = Másolás
terminal-info-dialog-copied = Másolva!
terminal-info-dialog-mouse-mode-tooltip-off = Egér követés kikapcsolva
terminal-info-dialog-mouse-mode-tooltip-x10 = X10 kompatibilis mód - csak kattintási események
terminal-info-dialog-mouse-mode-tooltip-vt200 = VT200 mód - kattintás és elengedés események
terminal-info-dialog-mouse-mode-tooltip-vt200highlight = VT200 highlight mód - szöveg kiemeléssel
terminal-info-dialog-mouse-mode-tooltip-btnevent = Gomb követés - tartalmazza a mozgást nyomás közben
terminal-info-dialog-mouse-mode-tooltip-anyevent = Teljes követés - minden esemény jelentve
