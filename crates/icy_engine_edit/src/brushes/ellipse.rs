...
pub fn get_ellipse_points(center: Position, radius_x: i32, radius_y: i32) -> Vec<(Position, PointRole)> {
    ...
    // Region 2: |slope| >= 1
    p = (ry2 * (x as i64 * 2 + 1).pow(2)) / 4 
        + rx2 * ((y - 1) as i64).pow(2) 
        - rx2 * ry2;
...
fn plot_ellipse_points(
    points: &mut Vec<(Position, PointRole)>,
    center: Position,
    x: i32,
    y: i32,
) {
...
pub fn draw_ellipse<T: DrawTarget>(
    target: &mut T,
    ctx: &DrawContext,
    center: Position,
    radius_x: i32,
...
pub fn fill_ellipse<T: DrawTarget>(
    target: &mut T,
    ctx: &DrawContext,
    center: Position,
    radius_x: i32,
...
pub fn draw_ellipse_from_rect<T: DrawTarget>(
    target: &mut T,
    ctx: &DrawContext,
    p0: Position,
    p1: Position,
...
pub fn fill_ellipse_from_rect<T: DrawTarget>(
    target: &mut T,
    ctx: &DrawContext,
    p0: Position,
    p1: Position,
