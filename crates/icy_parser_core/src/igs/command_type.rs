    ...
    pub fn create_command(self, sink: &mut dyn CommandSink, params: &[IgsParameter], text_buffer: &[u8]) -> Option<IgsCommand> {
        match self {
            ...
            IgsCommandType::ColorSet => {
                ...
                Self::check_parameters(params, sink, "ColorSet", 2, || IgsCommand::ColorSet {
                    pen,
            ...
            IgsCommandType::AttributeForFills => Self::check_parameters(params, sink, "AttributeForFills", 3, || {
                let pattern_type = match params[0].value() {
                    ...
                    1 => PatternType::Solid,
                    2 => PatternType::Pattern(params[1].value() as u8),
                    3 => PatternType::Hatch(params[1].value() as u8),
                    4 => PatternType::UserDefined(params[1].value() as u8),
                    _ => PatternType::Solid,
                };
            ...
            IgsCommandType::HollowSet => Self::check_parameters(params, sink, "HollowSet", 1, || IgsCommand::HollowSet {
            ...
            IgsCommandType::LineType => {
                ...
                Self::check_parameters(params, sink, "LineType", 3, || IgsCommand::LineStyle {
                    kind,
                    value: params[2].value() as u16,
                })
            }
            IgsCommandType::PauseSeconds => Self::check_parameters(params, sink, "PauseSeconds", 1, || IgsCommand::PauseSeconds {
            ...
            IgsCommandType::GraphicScaling => Self::check_parameters(params, sink, "GraphicScaling", 1, || IgsCommand::GraphicScaling {
            ...
            IgsCommandType::InverseVideo => Self::check_parameters(params, sink, "InverseVideo", 1, || IgsCommand::InverseVideo {
                enabled: params[0].value() != 0,
            }),
            IgsCommandType::LineWrap => Self::check_parameters(params, sink, "LineWrap", 1, || IgsCommand::LineWrap {
                enabled: params[0].value() != 0,
            }),
